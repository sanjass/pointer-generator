...
def get_art_abs(story_file):
  ...
  index = story_file.split("/")[-1].split(".")[0].strip()
  # make the abstract the index of the doc so that you can match the original doc with the summarized doc (if evaluating with rouge, change this to the ref summary)
  highlights = [index]
